...
class DashboardReconciliationRunner:
    ...
    def run(
        ...
        *,
        ...
        record.change_request_url = first_item.change_request_url
        ...
        if active_dry_run:
            ...
            return self.run_state_service.build_summary(
                ...
                change_request_url=first_item.change_request_url,
            )
    ...
    def _run_live(
        ...
        *,
        ...
        for item in selected_items:
            ...
            record.change_request_url = item.change_request_url
            record.updated_at = utc_now()
            ...
            if decision.action == "done":
                ...
                self.run_state_service.dashboard.mark_done(
                    ...
                    change_request_url=item.change_request_url,
                )
                reconciled_count += 1
                done_count += 1
                continue
