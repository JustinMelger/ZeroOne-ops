...
_INTERNAL_PIPELINE_RATIONALE_MARKERS = (
    ...
    "candidate survived",
    "candidates survived",
    "candidate survives precision",
    "candidates survive precision",
    "candidate survived precision",
    "candidates survived precision",
    "candidate reached precision",
    "candidates reached precision",
