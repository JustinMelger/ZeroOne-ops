...
| 2026-04-23 | !389 / 1798e8ee4eed806c1e7b4cda27ff8d854573165a | No-findings summary/reason still describes regression | no | The review returned `No actionable findings`, but the confidence reason said a finding was directly grounded in the changed schema code, which indicates a valid concern was suppressed during final classification | validator | tracking | Another live occurrence of the same contradiction class: the model appears to detect a concern internally but still publishes a clean-pass verdict. |
| 2026-04-23 | !390 / 193968676c7295e058ad2d0da17f4c47f83705c1 | No-findings summary/reason still describes regression | no | The review returned `No actionable findings` while the confidence reason described a clear user-visible behavioral change in a changed helper path, so the final artifact contradicted its own reasoning again | validator | tracking | Count as the same reconciliation-validator need: the concern was present in the rationale but suppressed by final packaging/classification. |
