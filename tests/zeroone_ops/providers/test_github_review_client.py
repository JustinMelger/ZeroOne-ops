...
def test_get_change_request_fetches_pull_request_and_files() -> None:
    ...
    assert change_request.diff_refs is None
...
def test_create_change_request_inline_comment_is_not_supported_in_phase_2() -> None:
    ...
    assert "not supported in Phase 2" in str(exc_info.value)
